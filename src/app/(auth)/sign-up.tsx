...
import { AppleIcon, ChevronRightIcon, GoogleIcon } from '@/components/icons';
...
export default function SignUpScreen() {
  ...
  }, [email, password, confirmPassword, refreshSession, router]);
      ...
      >
        ...
        >
          <TouchableOpacity onPress={() => router.back()} style={styles.backBtn} activeOpacity={0.7}>
            <ChevronRightIcon size={22} color={colors.foreground} style={styles.backChevron} />
          ...
          >
            {loading ? (
              ...
              <Text style={styles.primaryBtnLabel}>{t('createAccount')}</Text>
            )}
          </TouchableOpacity>
          ...
          <TouchableOpacity
            ...
            activeOpacity={0.7}
          >
            <Text style={styles.footerLinkText}>{t('alreadyHaveAccount')}</Text>
            <Text style={styles.footerLinkBold}>{t('signIn')}</Text>
          </TouchableOpacity>
        </ScrollView>
      </KeyboardAvoidingView>
    </View>
